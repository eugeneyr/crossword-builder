...
public class Settings {
    ...
    private int boardWidth = Constants.DEFAULT_BOARD_WIDTH;
    private int boardHeight = Constants.DEFAULT_BOARD_HEIGHT;
    ...
    static {
        ...
        options.addOption(Option.builder("x")
                ...
                .longOpt("maxWidth")
                .type(Integer.TYPE)
                .desc("Width of the crossword puzzle board")
                .build());
        options.addOption(Option.builder("y")
                .hasArg(true)
                .longOpt("maxHeight")
                .type(Integer.TYPE)
                .desc("Height of the crossword puzzle board")
                .build());
    ...
    public static Settings configure(String[] args, boolean printUsage) {
        ...
        try {
            ...
            if (line.hasOption("x")) {
                instance.boardWidth = Integer.parseInt(line.getOptionValue("x"));
            }
            if (line.hasOption("y")) {
                instance.boardHeight = Integer.parseInt(line.getOptionValue("y"));
            }
            if (line.hasOption("b")) {
